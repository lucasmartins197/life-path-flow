      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center relative z-10">
        ...
        <div className="w-full max-w-sm rounded-2xl p-5 text-left mb-6" style={{ backgroundColor: "#1B4332" }}>
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <p className="text-xs font-semibold" style={{ color: "#C9A84C" }}>Ana</p>
              <p className="text-xs" style={{ color: "rgba(255,255,255,0.7)" }}>Sua companheira de jornada</p>
            </div>
          </div>
          <p className="text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.92)" }}>
            "{firstName}, quero te lembrar de algo importante: <strong style={{ color: "#C9A84C" }}>tudo que você registrar aqui é para você.</strong> Se mentir no app, você está mentindo para si mesmo — e a única pessoa que perde é você. A honestidade nessa jornada é o que vai te libertar. Estou aqui com você. 💚"
          </p>
        </div>
